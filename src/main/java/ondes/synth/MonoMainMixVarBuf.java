...
public class MonoMainMixVarBuf extends MonoComponent {
    ...
    public MonoMainMixVarBuf(Mixer mixer) { this(mixer,2048); }

    public MonoMainMixVarBuf(Mixer mixer, int bufferSize) {
